...
function BuySell() {
    ...
    const handlePlus = () => {
        if (number >= 25) {
            setnumber(number + 0)
            alert("Bundan boshqa ko'paytirib bo'lmedi")
        } else {
            setnumber(number + 5)
        }
    }
    ...
    const handleMinus = () => {
        if (number <= 5) {
            setnumber(number - 0)
            alert("Bundan boshqa kamaytirib bo'lmedi")
        } else {
            setnumber(number - 5)
        }
    }
    ...
    return (
        <>
            <div className={`${open ? 'bggg h-[60%] absolute w-[70%] z-[1000000] flex justify-center items-center' : 'hidden'}`}>
                <div>
            ...
            <div className={modal ? "w-[70%] -mt-40 pt-24 bggg h-[90%] absolute z-[1000000] flex justify-center" : "hidden"}>
                <div>
                    <form onSubmit={formik.handleSubmit} className='bg-white p-10'>
                        ...
                        <label htmlFor="" className="mt-3">Currency Type:</label>
                        <input
                            id="type"
                            name="type"
                            className='border-2 py-2 px-4 block border-red-500'
                    ...
                    <tbody className="border shadow-md h-full">
                        {
                            user.map((item) => (
                                <tr class="border-y dark:bg-gray-900 text-black dark:border-gray-700" key={item.id}>
                                    ...
                                    <td class="px-6 py-4 text-black text-[18px] flex gap-1">
