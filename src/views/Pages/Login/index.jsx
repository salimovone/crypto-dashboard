...
import img4 from '../../../assets/img/icon/lock-icon.svg'
                ...
                <div>
                    ...
                    <div className="box_login">
                        ...
                        <div className="flex justify-between mt-5">
                            ...
                            <div className="flex gap-1">
                                <img src={img4} alt="" />
                                <Link className="text-red-500 hover:text-blue-600" to={"/forgotPassword"}>Forgot your password?</Link>
                            </div>
                        </div>

                        <div>
                            <button className="md:w-[450px] bg-blue-600 items-center font-semibold flex justify-center rounded-lg w-full h-[45px] text-center mt-5 text-white"><Link className="flex gap-1" to={"/"}>Sign In <BiRightArrowAlt className="mt-[3px] text-[20px]"/></Link></button>
                        </div>
